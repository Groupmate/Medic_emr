    ...
    <x-guest-layout>
       ...
       @endif 
        ...
        <div class="mt-4">
            ...
            <select  id ="role" wire:model.defer="role" class="block mt-1 w-full border-gray-300 focus:border" >
        ...
        <div class="mt-4">
            ...
            <select  id ="address" wire:model.defer="address" class="block mt-1 w-full border-gray-300 focus:border" >
                <option>---Select Manager Address---</option>
                <option value="Adama, Oromia">Adama, Oromia</option>
                <option value="Bahirdar, Amahara">Bahirdar, Amahara</option>
                <option value="Mekelle, Tigray">Mekelle, Tigray</option>
                <option value="Semera, Afar">Semera, Afar</option>
                <option value="Jigjiga, Somalia">Jigjiga, Somali</option>
                <option value="Harar, Harari">Harar, Harari</option>
                <option value="Hawassa, Sidama">Hawassa, Sidama</option>
                <option value="Hawassa, SNNPR">Hawassa, SNNPR</option>
                <option value="Jinka, SWNNPR">Jinka, SWNNPR</option>
                <option value="Gambela, Gambela">Gambela, Gambela</option>
                <option value="Assosa, Benishangul Gumuz">Assosa, Benishangul Gumuz</option>
                <option value="Addis Abeba, Ethiopia">Addis Ababa, Ethiopia</option>
            ...
            <div class="mt-4">
                ...
                <select id = "sex" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" wire:model.defer="sex" >
                    <option>---Select sex---</option>
                    <option value="male">Male</option>
                    <option value="female">Female</option>
                </select>
                @error('sex') <span style = "color:red" text-red-600">{{ $message }}</span>@enderror
            </div>
