    ...
    <form wire:submit.prevent="CreateEmployee" class="w-full">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-6">
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="last_name" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" wire:model.debounce.800ms="last_name" />
